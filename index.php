...
<html>
	<head>
		...
		<title>Julians Deli in the heart of Loveland, Ohio &gt; Home</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://juliansdeli.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Home</a>
                  </div>
              </div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">New Menu</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">News&promotions</a>
					</div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Entertainmet</a>
					</div>
				</div>
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Fundraisnig</a>
				</div>
					</div>
					<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-carat-r ui-btn-icon-right " href="#page2" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">About Us</a>
					</div>
				</div>
				</div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">New Menu</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">News&promotions</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Entertainmet</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">Fundraisnig</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>" data-direction="reverse">About Us</a></li>
